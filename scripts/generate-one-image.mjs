...
function prompt(extra=""){
  ...
  return [
    ...
    "No text, letters, numbers, labels, brand names, border, logo, watermark, people, hands, separate decorative props, duplicates, confusing extras, frightening details, malformed anatomy or cropped parts.",
    extra
  ].filter(Boolean).join(" ");
}
